    ...
    return (
        <div className="flex flex-raw">
            <Avatar
                ...
                src={data?.logo}
                alt="avatar"
                className="relative inline-block h-8 w-8 !rounded-full  object-cover object-center border-1 border-dark-green"
            />
...
export function renderTeacherName({ data }: CustomTableCellData) {
    return (
        <div className="flex flex-raw">
