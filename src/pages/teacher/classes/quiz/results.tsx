                                    ...
                                    <div className="pb-4">
                                        <div className="flex flex-col gap-6">
                                            <div>
                                                ...
                                                <span className="border-green-800 border-1 text-green-800 rounded-full px-2 py-0.5 ml-2 text-xs">
                                                    Correct
                                                </span>
                                                <span className="border-red-600 border-1 text-red-600 rounded-full px-2 py-0.5 ml-2 text-xs">
                                                    Incorrect
                                                </span>
                                            </div>
                                            <p className="pl-4">
