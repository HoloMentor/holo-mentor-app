...
export default function DeleteStudyPlan({ id }: ModelContainerProps) {
    const dispatch = useDispatch();

    const [deleteRecord, { isLoading: isDeleting, isError: isDeleteError, error: deleteError }] =
        studyPlanServices.useDeleteMutation();
    ...
    return (
        <div>
            <ModalHeader className="flex flex-col gap-1">Delete Study Plan</ModalHeader>
            <ModalBody>
